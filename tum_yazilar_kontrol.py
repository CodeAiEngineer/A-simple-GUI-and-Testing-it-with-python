...
class TestMyApp(unittest.TestCase):
    ...
    def test_show_all_color_and_text_control(self):
        ...
        for i in range(1,self.ui.new_window.layout().count()):
            ...
            if widget:
                ...
                self.assertEqual( widget.palette().color(QtGui.QPalette.WindowText).name(), expected_textsColorCodes[i-1], "Incorrect color in text")

        print("test_show_all_color_and_text_control")
